...
//               <span className={`block h-0.5 bg-gray-700 transition-all ${isOpen ? 'rotate-45 translate-y-1.5' : ''}`}></span>
//               <span className={`block h-0.5 bg-gray-700 transition-all ${isOpen ? 'opacity-0' : 'opacity-100'}`}></span>
//               <span className={`block h-0.5 bg-gray-700 transition-all ${isOpen ? '-rotate-45 -translate-y-1.5' : ''}`}></span>
//             </div>
//           </button>
//         </div>
...
//                 key={item.name}
//                 href={item.href}
//                 className="block py-3 px-4 text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg font-medium transition-all"
